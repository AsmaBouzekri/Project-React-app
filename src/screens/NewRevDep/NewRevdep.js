                ...
                <ScrollView style={{ flex: 0.9 }}>
                    ...
                    <View style={styles.view}>
                        ...
                        <TouchableOpacity style={{
                            ...
                            marginVertical: 5
                        }} onPress={() => { !rows.length ? Toast.show('ajouter une categorie d abord') : setModal(true) }} >
                            <Text style={styles.text}>{categorie}</Text></TouchableOpacity>
                    </View>
                    <View style={styles.view}>
                        ...
                        <TouchableOpacity style={{
                            ...
                            paddingHorizontal: 10,
                            marginVertical: 5
                        }} onPress={() => { !rows.length ? Toast.show('ajouter un budget d abord') : setModal1(true) }} >
                     <Text style={styles.text}>{compte}</Text></TouchableOpacity>
                    </View>
                    <View style={styles.view}>
...
const styles = StyleSheet.create({
    ...
    textTab: {
        alignSelf: 'center', color: Colors.darkgray, fontSize: 16, fontWeight: '600',
